...
class TableDetectionVOC(IMDB):
    def __init__(self, image_set, root_path, devkit_path):
        ...
        super(TableDetectionVOC, self).__init__('voc_' + year, image_set, root_path, devkit_path)  # set self.name
        self.year = year
    ...
    def load_pascal_annotation(self, index):
        ...
        roi_rec['height'] = int(size_obj.find('height').text)
        roi_rec['width'] = int(size_obj.find('width').text)
